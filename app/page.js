...
},
{
  ...
  content: [
    ...
    '"Four syllables!" Sarah shouts, rising to her feet.',
    'The crowd at Letter Griddle trivia night has never fallen so silent.',
    '"You\'ve got this friend!" Josephine speaks over the thick lull blanketing the trivia room, before blaring through the cafe speakers those four syllables that remind us that our lives are our own stories.',
  ],
...
},
{
  ...
  content: [
    ...
    '"On behalf of the foodies, I would like to place an order for Chicken Cordon Bleu," says Taylor.',
  ...
  closing: 'Readers, foodies, and cozy cooks, enjoy the beginning of your fall season dreams, plans, and menus. Be sure to enjoy today\'s Letter Griddle puzzle, available all seasons, 24/7. 💙',
  closingLink: 'https://lettergriddle.com/play',
  closingLinkText: 'Play Letter Griddle 💙'
},
{
