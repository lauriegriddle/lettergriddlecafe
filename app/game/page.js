...
// =============================================================================
  ...
  // PUZZLE 68: SPLATTER
  {
    ...
    totalWordCount: 82,
    words: {
      4: ['ALES', 'APES', 'AREA', 'EARL', 'EARS', 'EAST', 'EATS', 'ERAS', 'LATE', 'LEAP', 'PALE', 'PATE', 'PEAL', 'PEAR', 'PEAT', 'PLEA', 'RATE', 'REAP', 'SALE', 'SATE', 'SEAL', 'SEAR', 'SEAT', 'TALE', 'TAPE', 'TARE', 'TEAL', 'TEAR'],
      5: ['ALERT', 'ALTER', 'ARLES', 'ASTER', 'EARLS', 'LAPSE', 'LASER', 'LATER', 'LEAPS', 'PALES', 'PARSE', 'PASTE', 'PATER', 'PEALS', 'PEARS', 'PETAL', 'PLATE', 'PLEAT', 'RATES', 'REAPS', 'SALES', 'SLATE', 'SPARE', 'SPEAR', 'STALE', 'STARE', 'STEAL', 'TALES', 'TAPER', 'TAPES', 'TARES', 'TEALS', 'TEARS'],
